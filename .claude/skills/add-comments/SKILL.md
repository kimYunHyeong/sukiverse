---
name: add-comments
description: 코드를 작성하거나 수정할 때 항상 적용하는 주석 가이드라인입니다. 새 파일 생성, 기능 구현, 컴포넌트 작성, 함수 추가 등 모든 코드 작업 시 자동으로 이 스킬을 참고하여 주석을 포함해 작성합니다. 명시적으로 요청하지 않아도 코드 구현 과정에서 항상 적용됩니다.
---
